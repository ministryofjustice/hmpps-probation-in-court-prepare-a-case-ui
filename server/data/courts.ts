...
const isCourt = (courtCode: string): boolean => {
  return typeof courts.find(c => c.code === courtCode) !== 'undefined'
}

const courts: Array<Court> = [
  ...
  { code: 'B20BL', name: "Birmingham Magistrates' Court", pilotCourt: true },
  ...
  { code: 'B21DA', name: "Cannock Magistrates' Court", pilotCourt: true },
  { code: 'B46DB', name: "Canterbury Magistrates' Court", pilotCourt: true },
  ...
  { code: 'B20EY', name: "Dudley Magistrates' Court", pilotCourt: true },
  ...
  { code: 'B46FO', name: "Folkestone Magistrates' Court", pilotCourt: true },
  ...
  { code: 'B45GC', name: "Guildford Magistrates' Court", pilotCourt: true },
  ...
  { code: 'B22GR', name: 'Hereford Justice Centre', pilotCourt: true },
  ...
  { code: 'B22HM', name: "Kidderminster Magistrates' Court", pilotCourt: true },
  ...
  { code: 'B46IR', name: "Maidstone Magistrates' Court", pilotCourt: true },
  ...
  { code: 'B46IU', name: "Margate Magistrates' Court", pilotCourt: true },
  { code: 'B46DH', name: "Medway Magistrates' Court", pilotCourt: true },
  ...
  { code: 'B21JI', name: 'North Staffordshire Justice Centre', pilotCourt: true },
  ...
  { code: 'B22KS', name: "Redditch Magistrates' Court", pilotCourt: true },
  ...
  { code: 'B46LN', name: "Sevenoaks Magistrates' Court", pilotCourt: true },
  ...
  { code: 'B45MH', name: "Staines Magistrates' Court", pilotCourt: true },
  ...
  { code: 'B22MZ', name: "Telford Magistrates' Court", pilotCourt: true },
  ...
  { code: 'B20NQ', name: "Walsall Magistrates' Court", pilotCourt: true },
  ...
  { code: 'B20OQ', name: "Wolverhampton Magistrates' Court", pilotCourt: true },
  { code: 'C20WO', name: 'Wolverhampton Crown Court', pilotCourt: true },
  { code: 'B22OS', name: 'Worcester Justice Centre', pilotCourt: true },
